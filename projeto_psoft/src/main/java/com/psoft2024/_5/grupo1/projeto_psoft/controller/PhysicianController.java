...
import com.psoft2024._5.grupo1.projeto_psoft.service.PhysicianService;
...
import com.psoft2024._5.grupo1.projeto_psoft.service.FileStorageService;
...
public class PhysicianController {
    ...
    @GetMapping("/top-appointments")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<List<PhysicianAppointmentCountDTO>> getTop5PhysiciansByAppointments() {
        List<PhysicianAppointmentCountDTO> topPhysicians = physicianService.getTop5PhysiciansByAppointments();
        if (topPhysicians.isEmpty()) {
            return ResponseEntity.noContent().build(); // 204 se não houver dados para mostrar
        }
        return ResponseEntity.ok(topPhysicians);
    }
    ...
    public ResponseEntity<List<AvailableSlotDTO>> getAvailableSlots(
        ...
        try {
            List<AvailableSlotDTO> slots = physicianService.getAvailableSlots(physicianId, date);
            if (slots.isEmpty()) {
